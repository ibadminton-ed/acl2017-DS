...
%with the training data constructed by labeling sentences containing both the \emph{subj} and \emph{obj} of an existing \KB triple as supports for the exsistence of the triple. 
This extraction task can be conducted in both the sentence and the bag levels.
%using existing knowledge base, which can be applied in both the sentence and the bag levels.  
