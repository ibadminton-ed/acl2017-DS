...
We show that  dynamic transition matrices can effectively model the noise in the training data 
generated through distant supervision. 
...
\todo{I do not like the last sentence!!  btw, shall we consider \TimeRE as a contribution? }
