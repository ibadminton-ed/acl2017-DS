...
%
\blue{Because: 1) noisy data, 2) local optima. Therefore, we a strategy to guide our model to gradually adapt to the noisy training data, which means, learning something simple first, and then trying to deal with noises.}

\blue{Fortunately, this is exactly what CL can do. 
...
\red{characterize the noise and how to control its effect via trace regularization},
