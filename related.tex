...
classification~\cite{go2009twitter}, \orange{tweet named entity classifying}~\cite{ritter2011named}.
...
cross-lingual projection of training data. Our work advances \cite{fang2016learning} through dynamically generating a transition matrix for each data item,
providing a finer-grained, more effective way for modeling reliable and unreliable data. 
