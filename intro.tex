...
The recent breakthrough in neural networks~\cite{lin2016neural} provides a new way to reduce the influence of incorrectly labeled data 
...
Some promising results in neural network based \DS noise modeling have been reported in recent work~\red{\cite{}}, but this technique is still in its early stage and much remains to be done.

%This provides a new way to explicitly characterize the noise of the \DS output.
